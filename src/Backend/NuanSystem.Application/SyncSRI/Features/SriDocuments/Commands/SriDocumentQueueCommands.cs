...
public sealed record DownloadAuthorizedSriXmlCommand(long QueueId,int? AuditUserId,string? AuditUserName,Guid TraceId) : ICommand<SriAuthorizedXmlDownloadDto>;
