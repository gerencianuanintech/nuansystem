...
{
    public CreateItemGroupCommand(string code, string name, string? description, bool isActive,
        ...
        : this(code, name, description, null, null, isActive, inventoryAccountCode, salesAccountCode,
