...
public static class SyncMasterBranchEntityCodes
{
    ...
    [
        ...
        new(UnitOfMeasures, UnitOfMeasures, "Unidades de medida", true, true, true, true, true, true, "Catalogo Full con aplicacion por GlobalId y conflicto terminal sin adopcion por codigo; el CRUD incremental queda fuera de esta fase.", 50, SupportsIncremental: false),
