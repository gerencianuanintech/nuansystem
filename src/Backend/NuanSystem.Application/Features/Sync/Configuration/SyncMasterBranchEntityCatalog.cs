...
public static class SyncMasterBranchEntityCodes
{
    ...
    [
        ...
        new(BusinessPartnerProposalResult, BusinessPartnerProposalResult, "Resultados de propuestas de socios de negocio", true, true, false, false, false, false, "Productor de resultado dirigido disponible; permanece no operativa hasta incorporar el aplicador de sucursal en Task 9.", 202, DefaultKeyField: "GlobalId"),
