...
public sealed class SriDocumentMonitorFilter { public long? ImportId { get; set; } public string? Environment { get; set; } public string? Status { get; set; } public string? DocumentTypeCode { get; set; } public string? SourceType { get; set; } public DateTime? CreatedFrom { get; set; } public DateTime? CreatedTo { get; set; } public string? Search { get; set; } public int Page { get; set; }=1; public int PageSize { get; set; }=50; }
