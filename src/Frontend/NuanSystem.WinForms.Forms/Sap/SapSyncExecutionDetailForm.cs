...
public sealed partial class SapSyncExecutionDetailForm : XtraForm
{
    ...
    private void Bind()
    {
        ...
        detailGrid.DataSource = ViewModel.Details; UpdateActions();
    }
    ...
    private SapSyncExecutionDetailItem? SelectedDetail() => detailView.GetFocusedRow() as SapSyncExecutionDetailItem;
