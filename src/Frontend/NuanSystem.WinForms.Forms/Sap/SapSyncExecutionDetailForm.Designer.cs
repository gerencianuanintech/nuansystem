...
partial class SapSyncExecutionDetailForm
{
    ...
    private void InitializeComponent()
    {
        ...
        refreshButton.ButtonKind = NuanActionButtonKind.Refresh;
        refreshButton.ButtonText = "Actualizar";
        refreshButton.Location = new Point(12, 8);
        refreshButton.Name = "refreshButton";
        refreshButton.Size = new Size(104, 36);
        refreshButton.TabIndex = 0;
        retryButton.ButtonKind = NuanActionButtonKind.Retry;
        retryButton.ButtonText = "Reintentar";
        retryButton.Location = new Point(124, 8);
        retryButton.Name = "retryButton";
        retryButton.Size = new Size(104, 36);
        retryButton.TabIndex = 1;
        cancelButton.ButtonKind = NuanActionButtonKind.Cancel;
        cancelButton.ButtonText = "Cancelar";
        cancelButton.Location = new Point(236, 8);
        cancelButton.Name = "cancelButton";
        cancelButton.Size = new Size(104, 36);
        cancelButton.TabIndex = 2;
        releaseButton.ButtonKind = NuanActionButtonKind.Warning;
        releaseButton.ButtonText = "Liberar lock";
        releaseButton.Location = new Point(348, 8);
        releaseButton.Name = "releaseButton";
        releaseButton.Size = new Size(104, 36);
