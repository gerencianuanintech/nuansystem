...
{
    public OperationEditForm(SecurityOperationItem? operation = null, bool copyMode = false)
    {
        InitializeComponent();
    ...
    public SaveSecurityOperationRequest Request { get; private set; } = new(
        string.Empty,
        string.Empty,
        null,
        "Inicio",
    ...
    {
        Request = new SaveSecurityOperationRequest(
