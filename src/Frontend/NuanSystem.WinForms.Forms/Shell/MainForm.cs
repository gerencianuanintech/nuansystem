...
public sealed class MainForm : RibbonForm
{
    ...
    private Form? CreateModuleForm(ShellModuleItem module)
    {
        ...
        return module.Key switch
        {
            ...
            "item-origins" => generalInventoryCatalogFormFactory(module.Key),
            "item-commercial-segments" => generalInventoryCatalogFormFactory(module.Key),
            "item-alert-types" => generalInventoryCatalogFormFactory(module.Key),
            "inventory-item-lines" => generalInventoryCatalogFormFactory(module.Key),
            "item-subgroups" => generalInventoryCatalogFormFactory(module.Key),
            "inventory-item-subgroups" => generalInventoryCatalogFormFactory(module.Key),
            "sales-channels" => generalInventoryCatalogFormFactory(module.Key),
            ...
            "storage-conditions" => generalInventoryCatalogFormFactory(module.Key),
            "replenishment-methods" => generalInventoryCatalogFormFactory(module.Key),
