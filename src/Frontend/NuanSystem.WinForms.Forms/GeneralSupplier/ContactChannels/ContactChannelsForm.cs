...
public sealed partial class ContactChannelsForm : BaseGridCrudListForm
{
    ...
    public ContactChannelsForm(GeneralSupplierCatalogsViewModel viewModel, ApiSession session, IGridColumnSettingsClient columnSettingsClient)
    {
    ...
    {
        using var form = new ContactChannelEditForm();
    ...
    protected override async Task EditAsync()
    {
        ...
        using var form = new ContactChannelEditForm(fullItem);
        if (form.ShowDialog(this) != DialogResult.OK)
        {
            return;
        }
    ...
    protected override async Task CopyAsync()
    {
        ...
        var fullItem = await viewModel.GetByIdAsync(item.Id);
        using var form = new ContactChannelEditForm(fullItem, copyMode: true);
        if (form.ShowDialog(this) != DialogResult.OK)
        {
            return;
        }
