...
public sealed partial class ContactTypesForm : BaseGridCrudListForm
{
    ...
    public ContactTypesForm(GeneralSupplierCatalogsViewModel viewModel, ApiSession session, IGridColumnSettingsClient columnSettingsClient)
    {
    ...
    {
        using var form = new ContactTypeEditForm();
    ...
    protected override async Task EditAsync()
    {
        ...
        using var form = new ContactTypeEditForm(fullItem);
        if (form.ShowDialog(this) != DialogResult.OK)
        {
            return;
        }
    ...
    protected override async Task CopyAsync()
    {
        ...
        var fullItem = await viewModel.GetByIdAsync(item.Id);
        using var form = new ContactTypeEditForm(fullItem, copyMode: true);
        if (form.ShowDialog(this) != DialogResult.OK)
        {
            return;
        }
