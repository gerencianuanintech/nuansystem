...
public sealed partial class SupplierGroupEditForm : BaseEditForm
{
    private static readonly GeneralSupplierCatalogDescriptor Descriptor = GeneralSupplierCatalogDescriptors.SupplierGroups;

    public SupplierGroupEditForm()
    {
        InitializeComponent();
        ConfigureForm();
    }

    public SupplierGroupEditForm(GeneralSupplierCatalogItem item, bool copyMode = false)
        : this()
    {
    ...
    {
        Request = new SaveGeneralSupplierCatalogRequest(
            txtCode.Text.Trim(),
            txtName.Text.Trim(),
