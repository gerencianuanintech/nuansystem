...
public sealed partial class SupplierClassesForm : BaseGridCrudListForm
{
    ...
    public SupplierClassesForm(GeneralSupplierCatalogsViewModel viewModel, ApiSession session, IGridColumnSettingsClient columnSettingsClient)
    {
    ...
    {
        using var form = new SupplierClassEditForm();
    ...
    protected override async Task EditAsync()
    {
        ...
        using var form = new SupplierClassEditForm(fullItem);
        if (form.ShowDialog(this) != DialogResult.OK)
        {
            return;
        }
    ...
    protected override async Task CopyAsync()
    {
        ...
        var fullItem = await viewModel.GetByIdAsync(item.Id);
        using var form = new SupplierClassEditForm(fullItem, copyMode: true);
        if (form.ShowDialog(this) != DialogResult.OK)
        {
            return;
        }
