...
partial class SriDocumentMonitorForm
{
    ...
    private void InitializeComponent()
    {
        ...
        split=new SplitContainerControl(); documentGrid=new NuanDataGridControl(); tabs=new XtraTabControl(); detailTab=new XtraTabPage(); attemptsTab=new XtraTabPage(); auditTab=new XtraTabPage(); lblDetail=new LabelControl(); attemptGrid=new NuanDataGridControl(); auditGrid=new NuanDataGridControl();
        ...
        tabs.Dock=DockStyle.Fill; tabs.TabPages.AddRange(new XtraTabPage[] { detailTab,attemptsTab,auditTab });
        detailTab.Text="Detalle"; attemptsTab.Text="Intentos"; auditTab.Text="Auditoria";
        ...
        attemptGrid.Dock=DockStyle.Fill; attemptsTab.Controls.Add(attemptGrid); auditGrid.Dock=DockStyle.Fill; auditTab.Controls.Add(auditGrid); split.Panel2.Controls.Add(tabs);
