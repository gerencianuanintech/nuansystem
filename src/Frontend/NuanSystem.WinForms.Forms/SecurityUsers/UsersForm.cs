...
public sealed partial class UsersForm : BaseGridCrudListForm
{
    ...
    protected override async Task CreateAsync()
    {
        ...
        using var form = new UserEditForm(viewModel.Roles);
    ...
    protected override async Task EditAsync()
    {
        ...
        await viewModel.LoadCatalogsAsync();
        using var form = new UserEditForm(viewModel.Roles, user);
        if (form.ShowDialog(this) != DialogResult.OK)
        {
            return;
        }
    ...
    protected override async Task CopyAsync()
    {
        ...
        await viewModel.LoadCatalogsAsync();
        using var form = new UserEditForm(viewModel.Roles, user, copyMode: true);
        if (form.ShowDialog(this) != DialogResult.OK)
        {
            return;
        }
