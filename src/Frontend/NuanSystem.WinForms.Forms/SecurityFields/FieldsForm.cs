...
public sealed partial class FieldsForm : BaseGridCrudListForm
{
    ...
    protected override void ConfigureGridColumns()
    {
        ...
        ConfigureColumn(nameof(SecurityFieldItem.Code), "Codigo", 1, 150);
        ConfigureColumn(nameof(SecurityFieldItem.Name), "Nombre", 2, 160);
        ConfigureColumn(nameof(SecurityFieldItem.FieldKey), "Campo", 3, 160);
        ConfigureColumn(nameof(SecurityFieldItem.FormCode), "Codigo formulario", 4, 150);
        ConfigureColumn(nameof(SecurityFieldItem.FormName), "Formulario", 5, 180);
        ConfigureColumn(nameof(SecurityFieldItem.ControlType), "Tipo control", 6, 120);
        ConfigureColumn(nameof(SecurityFieldItem.DataType), "Tipo dato", 7, 100);
        ConfigureColumn(nameof(SecurityFieldItem.IsRequired), "Requerido", 8, 80);
        ConfigureColumn(nameof(SecurityFieldItem.IsReadOnly), "Lectura", 9, 70);
        ConfigureColumn(nameof(SecurityFieldItem.IsVisible), "Visible", 10, 70);
        ConfigureColumn(nameof(SecurityFieldItem.IsActive), "Activo", 11, 70);
    }

    private SecurityFieldItem? SelectedItem()
    {
        return SelectedGridItem<SecurityFieldItem>();
    }
