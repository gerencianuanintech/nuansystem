...
partial class RoleEditForm
{
    ...
    private void InitializeComponent()
    {
        ...
        btnCancelar.Location = new Point(294, 233);
        ...
        btnGuardar.Location = new Point(400, 233);
        ...
        Controls.SetChildIndex(chkAsignable, 0);
        Controls.SetChildIndex(chkSistema, 0);
        Controls.SetChildIndex(chkActivo, 0);
        Controls.SetChildIndex(sedOrden, 0);
        Controls.SetChildIndex(lblOrden, 0);
        Controls.SetChildIndex(memDescripcion, 0);
