...
public sealed partial class OperationsForm : BaseGridCrudListForm
{
    ...
    protected override void ConfigureGridColumns()
    {
        ...
        ConfigureColumn(nameof(OperationItem.Code), "Codigo", 1, 130);
        ConfigureColumn(nameof(OperationItem.Name), "Nombre", 2, 160);
        ConfigureColumn(nameof(OperationItem.Description), "Descripcion", 3, 240);
        ConfigureColumn(nameof(OperationItem.RibbonPageName), "Pagina ribbon", 4, 130);
        ConfigureColumn(nameof(OperationItem.RibbonGroupName), "Grupo ribbon", 5, 130);
        ConfigureColumn(nameof(OperationItem.ActionKey), "Accion", 6, 130);
        ConfigureColumn(nameof(OperationItem.DisplayOrder), "Orden", 7, 80);
    }

    private OperationItem? SelectedItem()
    {
        return SelectedGridItem<OperationItem>();
    }
