...
{
    public FieldEditForm(IReadOnlyCollection<FormItem> forms, FieldItem? securityField = null, bool copyMode = false)
    {
        InitializeComponent();
    ...
    public SaveFieldRequest Request { get; private set; } = new(
        0,
        string.Empty,
        string.Empty,
        string.Empty,
