...
public sealed partial class RetentionTypeEditForm : BaseEditForm
{
    private static readonly TaxCatalogDescriptor Descriptor = TaxCatalogDescriptors.RetentionTypes;

    public RetentionTypeEditForm()
    {
        InitializeComponent();
        ConfigureForm();
    }

    public RetentionTypeEditForm(TaxCatalogItem item, bool copyMode = false)
        : this()
    {
