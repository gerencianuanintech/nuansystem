...
public sealed partial class TaxpayerTypeEditForm : BaseEditForm
{
    private static readonly TaxCatalogDescriptor Descriptor = TaxCatalogDescriptors.TaxpayerTypes;

    public TaxpayerTypeEditForm()
    {
        InitializeComponent();
        ConfigureForm();
    }

    public TaxpayerTypeEditForm(TaxCatalogItem item, bool copyMode = false)
        : this()
    {
