...
public sealed partial class BusinessLineEditForm : BaseEditForm
{
    private static readonly FinancialCatalogDescriptor Descriptor = FinancialCatalogDescriptors.BusinessLines;

    public BusinessLineEditForm()
    {
        InitializeComponent();
        ConfigureForm();
    }

    public BusinessLineEditForm(FinancialCatalogItem item, bool copyMode = false)
        : this()
    {
    ...
    {
        Text = $"Nueva {Descriptor.SingularTitle}";
