...
public sealed partial class BankEditForm : BaseEditForm
{
    ...
    public BankEditForm(FinancialCatalogItem item, bool copyMode = false)
        : this()
    {
    ...
    {
        Request = new SaveFinancialCatalogRequest(
            txtCode.Text.Trim(),
            txtName.Text.Trim(),
