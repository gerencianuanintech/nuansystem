...
public sealed partial class AccountingPaymentMethodEditForm : BaseEditForm
{
    private static readonly FinancialCatalogDescriptor Descriptor = FinancialCatalogDescriptors.AccountingPaymentMethods;

    public AccountingPaymentMethodEditForm()
    {
        InitializeComponent();
        ConfigureForm();
    }

    public AccountingPaymentMethodEditForm(FinancialCatalogItem item, bool copyMode = false)
        : this()
    {
