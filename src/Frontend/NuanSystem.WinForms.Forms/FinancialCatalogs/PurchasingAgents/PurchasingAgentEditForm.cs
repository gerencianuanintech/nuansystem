...
public sealed partial class PurchasingAgentEditForm : BaseEditForm
{
    private static readonly FinancialCatalogDescriptor Descriptor = FinancialCatalogDescriptors.PurchasingAgents;

    public PurchasingAgentEditForm()
    {
        InitializeComponent();
        ConfigureForm();
    }

    public PurchasingAgentEditForm(FinancialCatalogItem item, bool copyMode = false)
        : this()
    {
