...
public sealed partial class PaymentPriorityEditForm : BaseEditForm
{
    private static readonly FinancialCatalogDescriptor Descriptor = FinancialCatalogDescriptors.PaymentPriorities;

    public PaymentPriorityEditForm()
    {
        InitializeComponent();
        ConfigureForm();
    }

    public PaymentPriorityEditForm(FinancialCatalogItem item, bool copyMode = false) : this() => LoadCatalog(item, copyMode);
