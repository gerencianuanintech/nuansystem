...
public sealed partial class BankAccountTypeEditForm : BaseEditForm
{
    private static readonly FinancialCatalogDescriptor Descriptor = FinancialCatalogDescriptors.BankAccountTypes;

    public BankAccountTypeEditForm()
    {
        InitializeComponent();
        ConfigureForm();
    }

    public BankAccountTypeEditForm(FinancialCatalogItem item, bool copyMode = false)
        : this()
    {
