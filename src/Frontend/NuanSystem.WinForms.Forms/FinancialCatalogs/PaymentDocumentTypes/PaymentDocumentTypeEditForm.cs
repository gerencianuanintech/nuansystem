...
public sealed partial class PaymentDocumentTypeEditForm : BaseEditForm
{
    private static readonly FinancialCatalogDescriptor Descriptor = FinancialCatalogDescriptors.PaymentDocumentTypes;

    public PaymentDocumentTypeEditForm()
    {
        InitializeComponent();
        ConfigureForm();
    }

    public PaymentDocumentTypeEditForm(FinancialCatalogItem item, bool copyMode = false) : this() => LoadCatalog(item, copyMode);
