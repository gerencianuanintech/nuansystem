...
public sealed class ItemEditState
{
    public ItemHeaderState Header { get; set; } = new();
    public ItemGeneralState General { get; set; } = new();
    public ItemUnitsState Units { get; set; } = new();
    public ItemInventoryState Inventory { get; set; } = new();
    public ItemPurchasingState Purchasing { get; set; } = new();
    public ItemSalesState Sales { get; set; } = new();
    public ItemCostsState Costs { get; set; } = new();
    public ItemAccountingState Accounting { get; set; } = new();
    public ItemTaxesState Taxes { get; set; } = new();
    public ItemTraceabilityState Traceability { get; set; } = new();
    public ItemVariantsState Variants { get; set; } = new();
    public ItemSapState Sap { get; set; } = new();
    public ItemAttachmentsState Attachments { get; set; } = new();
    public ItemRemarksState Remarks { get; set; } = new();
}

public sealed class ItemHeaderState
{
    ...
    public string SapStatus { get; set; } = "Pendiente";
}

public sealed class ItemGeneralState
{
...
public sealed class ItemUnitsState
{
    ...
    public List<ItemPresentationState> Presentations { get; } = [];
    public List<ItemBarcodeState> Barcodes { get; } = [];
}
...
public sealed class ItemBarcodeState
{
...
public sealed class ItemInventoryState
{
    ...
    public List<ItemWarehouseState> Warehouses { get; } = [];
}

public sealed class ItemWarehouseState
{
...
public sealed class ItemPurchasingState
{
...
public sealed class ItemSalesState
{
...
public sealed class ItemCostsState
{
    public decimal AverageCost { get; set; }
    ...
    public List<ItemCostComponentState> Components { get; } = [];
}

public sealed class ItemCostComponentState
{
...
public sealed class ItemAccountingState
{
...
public sealed class ItemTaxesState
{
...
public sealed class ItemTraceabilityState
{
...
public sealed class ItemVariantsState
{
...
public sealed class ItemSapState
{
    ...
    public List<ItemSapFieldMappingState> FieldMappings { get; } = [];
}

public sealed class ItemSapFieldMappingState
{
...
public sealed class ItemAttachmentsState
{
    public List<ItemAttachmentState> Files { get; } = [];
}

public sealed class ItemAttachmentState
{
