...
public sealed class ShellViewModel
{
    ...
    private static IReadOnlyCollection<ShellModuleItem> GetModuleDefinitions()
    {
        ...
        [
            ...
            new("Definiciones / General", "Países", "Mantenimiento de países", "countries", [PermissionCodes.GeographyCountriesRead, PermissionCodes.GeographyCountriesManage]),
            new("Definiciones / General", "Provincias", "Mantenimiento de provincias", "provinces", [PermissionCodes.GeographyProvincesRead, PermissionCodes.GeographyProvincesManage]),
            new("Definiciones / General", "Ciudades", "Mantenimiento de ciudades", "cities", [PermissionCodes.GeographyCitiesRead, PermissionCodes.GeographyCitiesManage]),
