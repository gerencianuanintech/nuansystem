...
public sealed class ShellViewModel
{
    ...
    private static IReadOnlyCollection<ShellModuleItem> GetModuleDefinitions()
    {
        ...
        [
            ...
            new("Modulo de configuracion / Definiciones / Inventario", "Grupos de Artículos", "Maestro de grupos de artículos", "item-groups", [PermissionCodes.ItemsRead, PermissionCodes.ItemsManage]),
            new("Modulo de configuracion / Definiciones / Inventario", "Familias de artículos", "Maestro de familias de artículos", "item-families", [PermissionCodes.GeneralInventoryItemFamiliesRead, PermissionCodes.GeneralInventoryItemFamiliesManage]),
            new("Modulo de configuracion / Definiciones / Inventario", "Marcas de artículos", "Maestro de marcas de artículos", "item-brands", [PermissionCodes.GeneralInventoryItemBrandsRead, PermissionCodes.GeneralInventoryItemBrandsManage]),
            new("Modulo de configuracion / Definiciones / Inventario", "Unidades de medida", "Maestro de unidades de medida", "unit-measures", [PermissionCodes.GeneralInventoryUnitMeasuresRead, PermissionCodes.GeneralInventoryUnitMeasuresManage]),
            new("Modulo de configuracion / Definiciones / Inventario", "Líneas de artículos", "Maestro de líneas de artículos", "item-lines", [PermissionCodes.GeneralInventoryItemLinesRead, PermissionCodes.GeneralInventoryItemLinesManage]),
            new("Modulo de configuracion / Definiciones / Inventario", "Orígenes de artículos", "Maestro de orígenes de artículos", "item-origins", [PermissionCodes.GeneralInventoryItemOriginsRead, PermissionCodes.GeneralInventoryItemOriginsManage]),
            new("Modulo de configuracion / Definiciones / Inventario", "Segmentos comerciales de artículos", "Maestro de segmentos comerciales de artículos", "item-commercial-segments", [PermissionCodes.GeneralInventoryItemCommercialSegmentsRead, PermissionCodes.GeneralInventoryItemCommercialSegmentsManage]),
            new("Modulo de configuracion / Definiciones / Inventario", "Tipos de alerta de artículos", "Maestro de tipos de alerta de artículos", "item-alert-types", [PermissionCodes.GeneralInventoryItemAlertTypesRead, PermissionCodes.GeneralInventoryItemAlertTypesManage]),
            new("Modulo de configuracion / Definiciones / Inventario", "Canales de venta", "Maestro de canales de venta", "sales-channels", [PermissionCodes.GeneralInventorySalesChannelsRead, PermissionCodes.GeneralInventorySalesChannelsManage]),
            new("Modulo de configuracion / Definiciones / Inventario", "Subgrupos de artículos", "Maestro de subgrupos de artículos", "item-subgroups", [PermissionCodes.GeneralInventoryItemSubgroupsRead, PermissionCodes.GeneralInventoryItemSubgroupsManage]),
