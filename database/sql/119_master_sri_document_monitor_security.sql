...
INSERT @Ops VALUES(N'ACTION.REFRESH',N'Actualizar',N'Recargar informacion.',N'refresh',10),(N'ACTION.CONSULT',N'Consultar',N'Consultar detalle e historial.',N'consult',20),(N'ACTION.DOWNLOAD_XML',N'Descargar XML',N'Descargar XML autorizado.',N'download-xml',30);
