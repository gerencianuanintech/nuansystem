...
BEGIN
    ...
    EXEC dbo.SP_NA_POST_BUSINESSPARTNERS_CREAR_LEGACY_ACCOUNTING_DIMENSIONS
        ...
        @AssignedBuyerCode = @AssignedBuyerCode, @Incoterm = @Incoterm,
        @CommercialDiscountPercent = @CommercialDiscountPercent, @PurchaseCurrencyCode = @PurchaseCurrencyCode,
        @PreferredWarehouseId = @PreferredWarehouseId, @PurchaseSupplierType = @PurchaseSupplierType,
        @PreferredWarehouseCode = @PreferredWarehouseCode, @MinimumOrderQuantity = @MinimumOrderQuantity,
        @ActiveForImport = @ActiveForImport, @SubjectToEvaluation = @SubjectToEvaluation,
        @AllowsUrgentPurchases = @AllowsUrgentPurchases, @AverageDeliveryDays = @AverageDeliveryDays,
