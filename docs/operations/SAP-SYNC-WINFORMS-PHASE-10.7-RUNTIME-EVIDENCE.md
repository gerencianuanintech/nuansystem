...
El respaldo verificado se conserva con el nombre `NuanSystem_Master_Phase107_20260731_201133.bak`. No se registran credenciales, cadenas de conexión, claves, JWT ni datos personales.
...
Se comprobaron navegación independiente, títulos, grillas, pestañas, acciones, tamaño mínimo, redimensionamiento y cierre. Durante la revisión se detectó que los botones heredados Guardar y Cancelar se superponían con el contenido del perfil. Se corrigió su ubicación en el pie del formulario y se añadió una prueba de regresión.
...
| Pruebas WinForms SAP dirigidas | 6 superadas, 0 fallidas. |
| Suite completa | 727 superadas, 5 diagnósticas omitidas y 0 fallidas. |
