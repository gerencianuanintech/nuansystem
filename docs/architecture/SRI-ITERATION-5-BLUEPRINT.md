...
- **Ausencias confirmadas al inicio:** tablas, repositorios, API, permisos, formularios, almacenamiento XML, cliente SRI y worker dedicados. Fases 5.2/5.3 cubrieron cola, API, permisos, proveedor, worker y XML store; Fase 5.5 implementa monitor y descarga protegida.
