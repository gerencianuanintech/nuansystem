...
La interfaz no expone la acción Ejecutar porque el backend todavía no publica un endpoint manual de ejecución. La migración 160 fue desplegada dos veces e idempotentemente en Master; los menús y operaciones fueron concedidos exclusivamente a ADMIN. La API validó 401/403/200, ambos conjuntos de Ribbon y la navegación independiente. Los formularios fueron revisados en runtime y los diseñadores de perfil y detalle abrieron correctamente en Visual Studio. La evidencia saneada está en [SAP-SYNC-WINFORMS-PHASE-10.7-RUNTIME-EVIDENCE.md](../operations/SAP-SYNC-WINFORMS-PHASE-10.7-RUNTIME-EVIDENCE.md). No se inició ningún worker ni se llamó SAP o SRI.
