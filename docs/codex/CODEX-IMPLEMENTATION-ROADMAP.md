...
- Pendiente C.3: cerrar el limite transaccional definitivo entre persistencia tenant y `SyncOutbox` Master antes de conectar `Items`, `Warehouses` u otras entidades.
